...
libraries <- c("XML", "rvest", "dplyr", "data.table", "DT")
...
The function to simulate a single posession:
```{r}
# possession function
...
# testing it out
playByPlay <- data.frame("Team" = character(), "Player" = character(), "Event" = character(), "Points" = double(), stringsAsFactors = F) 
possession(team_A = "UTA", team_B = "TOR", printPlayByPlay = T, def_multiplier = 1)
...
for(j in 1:nGames){
  ...
  print(paste0(j, "/", nGames)) #counter to keep track of how the simulation is going
}
